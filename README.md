...
## 3. Werbung und Einwilligung

Die kostenlose Version enthält Google AdMob und die Google User Messaging Platform
...
- [Datennutzung durch Google](https://policies.google.com/technologies/partner-sites)
- [Datenschutzerklärung von Google](https://policies.google.com/privacy)

## 4. Pro-Version und In-App-Kauf

Der Pro-Kauf ist im derzeitigen Test-Build nur simuliert; es findet keine echte Zahlung
statt. Vor Aktivierung eines produktiven In-App-Kaufs wird diese Erklärung um die dabei
eingesetzten Store- und Kaufdienste sowie deren Datenverarbeitung ergänzt.

## 5. Berechtigungen und Gerätefunktionen

Die App kann lokale Benachrichtigungen für Erinnerungen verwenden. Export- und
Teilen-Funktionen verwenden die entsprechenden Systemdialoge des Geräts. Eine
Kontaktaufnahme per E-Mail wird nur auf ausdrückliche Aktion des Nutzers über die
installierte E-Mail-App gestartet.

## 6. Speicherdauer und Löschung

Lokal gespeicherte App-Daten bleiben auf dem Gerät, bis sie in der App gelöscht oder
